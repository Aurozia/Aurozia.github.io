    ...
    <main>
        ...
        <section id="main-section">
            <section id="main-section-container-page">
                ...
                <div id="body-main">
                    <div id="karmine-corp-container">
                        <header id="karmine-corp-header">
                            <h1 id="karmine-corp-h1">Karmine Corp<strong id="karmine-corp-header-strong">Le club</strong></h1>
                        </header>
                        <main id="karmine-corp-main">
                            <section id="karmine-corp-container-presentation">
                                <h2 class="karmine-corp-h2">Présentation</h2>
                                <article id="karmine-corp-club-presentation">
                                    <img id="karmine-corp-club-logo-white" src="images/karmine-corp/KC_logo_white.png" alt="Logo Karmine Corp">
                                    <p>La <strong id="karmine-corp-strong">Karmine Corp</strong> (surnommée KCorp) est une structure française centrée autour d'une équipe e-sport immatriculée à Tours et basée à Paris. Elle est formée le 30 mars 2020 sous le nom de Kameto Corp par le duo de streamers francophones Kameto et Kotei. Le 16 novembre 2020, l'entrepreneur et rappeur français Prime rejoint la direction de la structure, et l'équipe prend sa dénomination actuelle. Une société par actions simplifiée, présidée par Kameto et dirigée par Prime, est créée quelques mois plus tard.</p>
                                </article>
                                <article id="karmine-corp-club-discovery">
                                ...
                                <article id="karmine-corp-club-kcorp">
                                    <h3 class="karmine-corp-h3">KCORP</h3>
                            ...
                            <section id="karmine-corp-container-players">
                                <h2 class="karmine-corp-h2">Joueurs et Staff LoL <em>(EMEA Masters Summer Split 2023)</em></h2>
                                <nav>
                            ...
                            <section id="karmine-corp-container-pictures">
                                ...
                                <div id="karmine-corp-wrap">
                                    ...
                                    <article class="karmine-corp-article">
                                        ...
                                        <h3 class="karmine-corp-h3">EUMasters 2022</h3>
                                        <p>Spring Split</p>
                                    </article>
                                    <article class="karmine-corp-article">
                                        <img src="images/karmine-corp/KC_champion_emeam_2023_summer_split.png" alt="KC Champion EMEA Masters 2023 Summer Split">
                                        <h3 class="karmine-corp-h3">EMEA Masters 2023</h3>
                                        <p>Summer Split</p>
                                    </article>
                                </div>
                            </section>
                        </main>
                        <footer id="karmine-corp-footer">

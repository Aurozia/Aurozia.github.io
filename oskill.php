    ...
    <main>
        ...
        <section id="main-section">
            <section id="main-section-container-page">
                ...
                <div id="body-main">
                    <div id="oskill-container">
                        <div id="oskill-left">
                            <header id="oskill-left-header">
                                <div id="oskill-left-header-help">
                                    <h1 id="oskill-left-header-title">Mes skills</h1>
                                </div>
                            </header>
                            <main id="oskill-left-main">
                                <h2 id="oskill-left-main-h2">Valentine YAO <em id="oskill-left-main-subtitle">Futur développeuse</em></h2>
                                <p class="oskill-left-main-p">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor. Cras elementum ultrices diam. Maecenas ligula massa, varius a, semper congue, euismod non, mi. Proin porttitor, orci nec nonummy molestie, enim est eleifend mi, non fermentum diam nisl sit amet erat. Duis semper. Duis arcu massa, scelerisque vitae, consequat in, pretium a, enim. Pellentesque congue. Ut in risus volutpat libero pharetra tempor. Cras vestibulum bibendum augue. Praesent egestas leo in pede. Praesent blandit odio eu enim. Pellentesque sed dui ut augue blandit sodales. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aliquam nibh. Mauris ac mauris sed pede pellentesque fermentum. Maecenas adipiscing ante non diam sodales hendrerit.</p>
                            </main>
                            <footer id="oskill-left-footer">
                                <nav id="oskill-nav">
                        ...
                        <div id="oskill-right">
                            <header id="oskill-right-header">
                                <h1 id="oskill-right-header-h1">Mes compétences</h1>
                            </header>

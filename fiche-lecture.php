                    ...
                    <div id="fiche-lecture-container">
                        ...
                        <main id="fiche-lecture-main">
                            <section class="fiche-lecture-section">
                                ...
                                <p class="fiche-lecture-paragraph">Avec les balises <strong class="bold-underline">h1-h6</strong> il est possible de définir des titres en respectant une logique de profondeur :</p>
                                ...
                                <p class="fiche-lecture-paragraph">Pour représenter un paragraphe de texte courant la balise <strong class="bold-underline">p</strong> est parfaite.</p>
                                <p class="fiche-lecture-paragraph"><strong class="bold-underline">&lt;strong&gt;</strong> et <strong class="bold-underline">&lt;em&gt;</strong> sont des balises permettant de définir des mots ou expressions <strong class="bold-underline">signifiants</strong> dans un texte courant.</p>
                            </section>
                            <section class="fiche-lecture-section">
                                ...
                                <p class="fiche-lecture-paragraph">C'est le nom de l'élement HTML situé au début de l'ensemble de règles. Il permet de sélectionner les éléments sur lesquels appliquer le syle souhaité (en l'occurence, les élémens p). Pour mettre en dorme un élément différent, il suffit de changer le sélecteur.</p>
                                <h4 class="fiche-lecture-h4">Déclaration</h4>
                                <p class="fiche-lecture-paragraph">C'est une règle simple comme color: red; qui détermine les propriétés de l'élément que l'on veut mettre en forme.</p>
                                <h4 class="fiche-lecture-h4">Propriétés</h4>
                                <p class="fiche-lecture-paragraph">Les différentes façons dont on peut mettre en forme un élément HTML (dans ce cas, color est une propriété des éléments p). En CSS, vous choisissez les différentes propriétés que vous voulez utiliser dans une règle CSS.</p>
                                <h4 class="fiche-lecture-h4">Valeur de la propriété</h4>
                                <p class="fiche-lecture-paragraph">À droite de la propriété, après les deux points, on a la valeur de la propriété. Celle-ci permet de choisir une mise en forme parmi d'autres pour une propriété donnée (par exemple, il y a d'autres couleurs que red pour la propriété color).</p>
                            </section>
                        </main>
